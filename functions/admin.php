...
$auth_users = array(
    $config['username'] => password_hash($config['password'], PASSWORD_DEFAULT)
);
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        <div class=" text-center">
                            <a href="<?php echo $siteinfo['siteURL']; ?>"><img border=0 width=200  height=200 src="../static/image/Login.png" ></a>
                        </div>
                        <div class="card fat">
                            <div class="card-body">
...
if (isset($_GET['upload']) && !FM_READONLY) {
    ...
    <link href="https://cdnjs.loli.net/ajax/libs/dropzone/5.5.1/min/dropzone.min.css" rel="stylesheet">
    <div class="path">
...
function fm_show_nav_path($path)
{
    ...
    <!--顶部导航栏-->
	<nav class="navbar sticky-top navbar-expand-lg navbar-light bg-white shadow-sm border-bottom">
	<div class="container big-nav">
		<a class="navbar-brand" href="<?php global $siteinfo; echo $siteinfo['siteURL']; ?>">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
				...
				<a class="nav-link" href="<?php global $siteinfo; echo $siteinfo['siteURL']; ?>"><i class="fa fa-home"></i>首页</a>
				</li>
			      <?php if (!FM_READONLY): ?>
                    ...
                    <li class="nav-item active">
                        <a title="<?php echo lng('Cache') ?>" class="nav-link" href="<?php global $siteinfo; echo $siteinfo['siteURL'].'?c=cache&del=cache'; ?>"><i class="fa fa-trash"></i> 清理缓存</a>
                    </li>
                    <li class="nav-item active">
                        <a title="<?php echo lng('Settings') ?>" class="nav-link" href="?p=&settings=1"><i class="fa fa-cog" ></i> <?php echo lng('Settings') ?></a>
                    </li>               
		...
		<!--
				...
				<a class="nav-link dropdown-toggle text-dark" href="./README.htm" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">	关于我们
				</a>
				<div class="dropdown-menu" aria-labelledby="navbarDropdown">
					<a class="dropdown-item" href="https://github.com/houkihou/BeautyDirectory" target = "_blank">设计源码</a>
					<a class="dropdown-item" href="./README.htm" target = "_blank">帮助文档</a>
...
<head>
    ...
    <meta name="robots" content="noindex, nofollow">
    <meta name="googlebot" content="noindex">
    <link rel="icon" href="<?php echo fm_enc($favicon_path) ?>" type="image/x-icon">
    <title><?php echo fm_enc(APP_TITLE) ?></title>
    <link rel="stylesheet" href="https://lib.sinaapp.com/js/bootstrap/4.3.1/css/bootstrap.min.css">
    <link rel="stylesheet" href="https://cdnjs.loli.net/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    <link rel="stylesheet" href="https://cdnjs.loli.net/ajax/libs/ekko-lightbox/5.3.0/ekko-lightbox.css" />
    <?php if (FM_USE_HIGHLIGHTJS): ?>
    <link rel="stylesheet" href="https://cdnjs.loli.net/ajax/libs/highlight.js/9.15.10/styles/<?php echo FM_HIGHLIGHTJS_STYLE ?>.min.css">
    <?php endif; ?>
    <style>
...
<script src="https://cdnjs.loli.net/ajax/libs/ekko-lightbox/5.3.0/ekko-lightbox.min.js"></script>
<?php if (FM_USE_HIGHLIGHTJS): ?>
