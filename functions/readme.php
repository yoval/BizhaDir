...
<body style = "background-color:#FFFFFF;">
	...
	<div class="footer">
		<hr />
		<p align="center" style='text-align:center'> Copyright &copy;<?php echo date("Y")." "; ?>  <a href="https://soft.ulmt.com/" target = "_blank" title = "Beauty Directory">Beauty Directory</a> </p>
	</div>
